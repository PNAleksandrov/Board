...
SECRET_KEY = 'django-insecure-fphl7+vyu#cdo!g1)%9)+e2l6vykn*9n6u+=-^i6yz%t4ve@0#'
...
EMAIL_HOST_USER = 'windmilll'  # ваше имя пользователя, например, если ваша почта user@yandex.ru,
